...
Route::prefix('manager')->name('manager.')->middleware([ManagerAuthenticate::class])->group(function () {
    ...
    Route::get('/theaters/{theater}/screens/{screen}/seats/{seat}/edit', [SeatController::class, 'edit'])
        ->name('theaters.screens.seats.edit');

    Route::put('/theaters/{theater}/screens/{screen}/seats/{seat}', [SeatController::class, 'update'])
        ->name('theaters.screens.seats.update');

    Route::put('/theaters/{theater}/screens/{screen}/seats', [SeatController::class, 'bulkUpdate'])
