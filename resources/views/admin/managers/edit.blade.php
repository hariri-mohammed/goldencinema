...
@section('content')
    <div class="under-nav">
        <div class="info-container">
            ...
            <form id="edit-form" action="{{ route('admin.managers.update', $manager->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="rows mb-4 mt-3">
                    ...
                    <div class="info-field col-sm-6">
                        ...
                        <input type="text" name="phone_number" value="{{ old('phone_number', $manager->phone_number) }}"
                            class="form-control ms-5 ps-3" required>
                    </div>
